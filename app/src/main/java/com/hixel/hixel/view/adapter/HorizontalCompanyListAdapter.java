...
public class HorizontalCompanyListAdapter extends
    RecyclerView.Adapter<HorizontalCompanyListAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public HorizontalCompanyListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
        int viewType) {
